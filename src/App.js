...
export default function App() {
  return (
    <div className="min-h-screen bg-gray-900 text-white flex flex-col items-center justify-center">
      <h1 className="text-2xl font-bold">Selamat Datang di Tap-to-Earn</h1>
      <p className="text-gray-400">Aplikasi penghasil koin berbasis Solana</p>

      {/* Tambahkan komponen BottomNav */}
      <BottomNav />
    </div>
  );
}